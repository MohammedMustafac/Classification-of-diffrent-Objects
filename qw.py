...
my_downloader.download('Laptop', limit=100)
my_downloader.download('Speakers', limit=100)
my_downloader.download('table', limit=100)
my_downloader.download('Keyboard', limit=100)